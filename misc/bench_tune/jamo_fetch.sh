...
jamo info filtered -s dori spid $(cat /REDACTED_HPC_PATH/ynp/metaTs_ITS_spIDs.lst) > YNP_RNA_info_fastqs_08072024.tsv
jamo fetch filtered -s dori spid $(cat /REDACTED_HPC_PATH/ynp/metaTs_ITS_spIDs.lst)
...
jamo info assembled.fna -s dori spid $(cat /REDACTED_HPC_PATH/ynp/metaGs_GS_ITS_spIDs.lst) > YNP_DNA/YNP_DNA_info_assembelies.tsv
jamo fetch assembled.fna -s dori spid $(cat /REDACTED_HPC_PATH/ynp/metaGs_GS_ITS_spIDs.lst)
